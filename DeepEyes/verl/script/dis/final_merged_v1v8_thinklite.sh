...
export SAVE_CHECKPOINT_DIR=/volume/pt-train/users/txie/misc/CKPT/M3-debug
# export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues
export LLM_AS_A_JUDGE_BASE="http://172.16.43.156:18900/v1"
BASEDIR=/volume/pt-train/users/txie/misc/Data/DeepEyes-Datasets-47k
...
REF_MODEL_PATH=/volume/pt-train/users/txie/misc/Models/Qwen/Qwen2.5-VL-7B-Instruct
